 ...
 *
 */
function rationalAspectRatio(image) {
    var width = image.clientWidth;
    var height = image.clientHeight;
    console.log(width);
}
var image = 'https://raw.githubusercontent.com/mouredev/mouredev/master/mouredev_github_profile.png';
rationalAspectRatio(image);
